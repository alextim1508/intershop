INSERT INTO user_details(username, password, roles, created) values ('alex', '$2a$10$sDqj8YbK78ZdBcUU1O6/o.BSep4OkUkNcMnAXTsyd/FT.I.9IOr5a', '["role1","role2"]', CURRENT_DATE) ON CONFLICT DO NOTHING;
